...
if __name__ == "__main__":
    ...
    val_target_file = "./data/train_x.1.txt"
    val_source_file = "./data/train_y.1.txt"
    ...
    print('src:', SRC_VOCAB_SIZE, 'tgt:', TGT_VOCAB_SIZE) 
    ...
    for epoch in range(1, NUM_EPOCHS+1):
        ...
        if val_loss < best:
            torch.save(transformer.state_dict(), './btmodel/%smodel%s%s%s%s.pkt'%(BATCH_SIZE, epoch, EMB_SIZE, NHEAD, NUM_ENCODER_LAYERS))
