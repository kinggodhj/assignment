...
from model_check import Seq2SeqTransformer, create_mask, greedy_decode
...
parser.add_argument('--ffd_dim', type=int, default=256)
...
PATH = './premodel/model%s%s%s%s.pkt'%(args.epochs, EMB_SIZE, NHEAD, NUM_ENCODER_LAYERS)
...
if __name__ == "__main__":
    ...
    print('train:', train_bleu, 'test:', bleu)
